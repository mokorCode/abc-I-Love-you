  ...
  <main>
    <div class="welcome-options fadeIn" v-if="loadOptions">
      <li @click="mitter.emit('continue')">
        <i
          @mouseenter="continueGameShow"
          @mouseout="continueGameRemove"
          @mousemove="continueGameMove"
          class="continue"
          >CONTINUE <br />-
        </i>
      </li>
      <li @click="mitter.emit('newGame')">
        <i class="newgame">NEWGAME <br />- </i>
      </li>
      <li>
        <i class="memories">MEMORIES <br />- </i>
      </li>
      <li>
        <i class="about">ABOUT <br />- </i>
      </li>
    </div>
